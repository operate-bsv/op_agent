defmodule FBAgent.VM.Extension.StringTest do
  use ExUnit.Case
  alias FBAgent.VM
  doctest FBAgent.VM.Extension.String

  setup_all do
    %{ vm: VM.init |> FBAgent.VM.Extension.String.extend }
  end

  describe "FBAgent.VM.Extension.String.pack/2" do
  ...
  describe "FBAgent.VM.Extension.String.unpack/2" do
